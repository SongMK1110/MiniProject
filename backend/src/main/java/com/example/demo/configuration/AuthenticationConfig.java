        ...
        protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
                return http
                                ...
                                .authorizeHttpRequests(requests -> requests
                                                // .requestMatchers(new
                                                // AntPathRequestMatcher("/resources/**")).permitAll()
                                                // .requestMatchers(new
                                                ...
                                                // .requestMatchers(new
                                                // AntPathRequestMatcher("/productDetail")).permitAll()
                                                // .requestMatchers(new AntPathRequestMatcher("/signForm")).permitAll()
                                                .requestMatchers(new AntPathRequestMatcher("/api/login")).permitAll()
                                                .requestMatchers(new AntPathRequestMatcher("/api/productList"))
                                                .permitAll()
                                                .requestMatchers(new AntPathRequestMatcher("/api/productDetail"))
                                                .permitAll()
                                                .requestMatchers(new AntPathRequestMatcher("/api/reviewProductDetail"))
                                                .permitAll()
                                                .requestMatchers(new AntPathRequestMatcher("/api/reviewRateAvg"))
                                                .permitAll()
